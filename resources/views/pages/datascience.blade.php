@extends('layouts.app')
@section('title', 'Data Science | Findworka Academy')
@section('content')
    <header class="data-science">
        <h1 class="data-science-intro text-white font-weight-bold">Data Science</h1>
    </header>
        ...
        <div>
            <div class="row mt-5">
                <div class="col-lg-8 col-md-8 col-sm-7">
                    ...
                    <p class="small">
                        Data science covers the whole spectrum of data processing, including the algorithmic or statistical aspects. 
                        ...
                        Data science applies machine learning, predictive analytics,
                        and sentiment analysis to extract critical information from the collected data sets.
                    </p>
                    <h3 class="mt-3 font-weight-bold">What you'll learn</h3>
                    <ul>
                        <li class="m-3 small">Introduction to Data science</li>
                        <li class="m-3 small">Python For Data Science</li>
                        <li class="m-3 small">Advanced Unix/Linux</li>
                        <li class="m-3 small">Machine Learning</li>
                        <li class="m-3 small">Big Data, HDFS</li>
                ...
                <a href="{{url('download/1')}}" class="btn text-white btn-block mt-3 font-weight-bold" style="background-color:black">Download Syllabus!</a>
                    <a href="{{url('apply/2')}}" class="btn text-white btn-block mt-3 font-weight-bold" style="background-color:purple">Apply Now!</a>
                </div>
            </div>
        </div>
