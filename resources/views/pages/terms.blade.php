...
@section('content')
    <h1> Welcome to our terms and condition page </h1>
        ...
        <p>The following terms and conditions govern all use of the MOOC List website and all content, services and products available through the website, including, but not limited to, the user area (collectively referred to as the Site).</p>

        <p>The Site is owned and operated by CoToNet Unip. LDA (collectively referred to as the Operator). The Site is offered subject to your acceptance without modification of all of the terms and conditions contained herein and all other operating rules, policies (including, without limitation, the Operator's Privacy Policy) and procedures that may be published from time to time on this Site by the Operator (collectively, the "Agreement").</p>

        <p>Please read this Agreement carefully before accessing or using the Site. By accessing or using any part of the web site, you agree to become bound by the terms and conditions of this agreement. If you do not agree to all the terms and conditions of this agreement, then you may not access the Site or use any services. The Site is available only to individuals who are at least 13 years old.</p>

        <p><b>User area account</b></p>

        <p>You are responsible for maintaining the security of your user area account, and you are fully responsible for all activities that occur under the account and any other actions taken in connection with the account. You must immediately notify the Operator of any unauthorized uses of your account or any other breaches of security. The Operator will not be liable for any acts or omissions by You, including any damages of any kind incurred as a result of such acts or omissions.</p>

        <p><b>Contribution to website</b></p>
        ...
        <p><b>Responsibility of website visitors</b></p>
...
<p>
        ...
        The Operator may terminate your access to all or any part of the Site at any time, with or without cause, with or without notice, effective immediately. If you wish to terminate this Agreement you may simply discontinue using the Site. Notwithstanding the foregoing, if you have a user account, such account can only be terminated by the Operator if you materially breach this Agreement and fail to cure such breach within 14 (fourteen) days from the Operator's notice to you thereof; provided that, the Operator can terminate the Site immediately as part of a general shut down of our service. All provisions of this Agreement which by their nature should survive termination shall survive termination, including, without limitation, ownership provisions, warranty disclaimers, indemnity and limitations of liability.

        <p><b>Disclaimer of warranties</b></p>

        The Site is provided "as is". The Operator and its suppliers and licensors hereby disclaim all warranties of any kind, express or implied, including, without limitation, the warranties of merchantability, fitness for a particular purpose and non-infringement. Neither the Operator nor its suppliers and licensors, makes any warranty that the Site will be error free or that access thereto will be continuous or uninterrupted. You understand that it is your responsibility to ensure that the privacy policy you create is complete, accurate, and meets your companies specific privacy needs. We are not liable or responsible for any privacy policies created using our services, and we give no representations or warranties, express or implied, that the privacy policies created using our service are complete, accurate or free from errors or omissions.
        ...
        <p><b>General representation and warranty</b></p>

        You represent and warrant that (i) your use of the Site will be in strict accordance with the the Operator Privacy Policy, with this Agreement and with all applicable laws and regulations (including without limitation any local laws or regulations in your country, state, city, or other governmental area, regarding online conduct and acceptable content, and including all applicable laws regarding the transmission of technical data exported from the United States or the country in which you reside) and (ii) your use of the Site will not infringe or misappropriate the intellectual property rights of any third party.
        ...
        <p>This Agreement constitutes the entire agreement between the Operator and you concerning the subject matter hereof, and they may only be modified by a written amendment signed by an authorized executive of the Operator, or by the posting by the Operator of a revised version. Except to the extent applicable law, if any, provides otherwise, this Agreement, any access to or use of the Site will be governed by the laws of Portugal, excluding its conflict of law provisions, and the proper venue for any disputes arising out of or relating to any of the same will be the courts located in Nigeria. 
