@extends('layouts.app')
@section('title','Product Design | Findworka Academy')
@section('content')
<header class="ui-ux">
    <h1 class="ui-ux-intro text-white font-weight-bold">Product Design</h1>
</header>
    ...
    <div>
        <div class="row mt-5">
            <div class="col-lg-8 col-md-8 col-sm-7">
                ...
                <p class="small">
                    Product design is all about details. It is the part of the design process that defines the final quality 
                    of a product. It is the process of visual communication through the use of typography, photography and 
                    illustration to create and combine symbols, 
                    images and text to form visual representations of ideas and messages.
                </p>
                <h3 class="mt-3 font-weight-bold">What you'll learn</h3>
                <ul>
                    <li class="m-3 small">Web and mobile user interface design</li>
                    <li class="m-3 small">Web and mobile user experience design</li>
                    <li class="m-3 small">Wireframing and prototyping</li>
                    <li class="m-3 small">Customer Journey Mapping</li>
                    <li class="m-3 small">Projects</li>
                </ul>
            ...
            <div class="col-lg-4 col-md-4 col-sm-5">
                ...
                <div class="card mt-3 card-shadow-web">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="font-weight-bold">Starts</p>
                            </div>
                            <div class="col-md-6">
                                <p class="text-center">April 15th, 2020</p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="font-weight-bold">Ends</p>
                            </div>
                            <div class="col-md-6">
                                <p class="text-center">July 19th, 2020</p>
                            </div>
                ...
                <div class="card mt-3 card-shadow-web">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="font-weight-bold">Mon-Sat</p>
                            </div>
                            <div class="col-md-6">
                                <p class="text-center">09:00am - 12:00pm</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <p class="text-center">12:00pm - 4:00pm</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card mt-3 card-shadow-web">
                    <div class="row p-3">
                        ...
                        <div class="col-md-6">
                            <p class="lead text-center">150,000</p>
                        </div>
                    </div>
                </div>
