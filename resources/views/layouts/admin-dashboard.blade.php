...
<head>
    ...
    <link rel="stylesheet" href= href="{{ secure_asset('css/style.css') }}">
        ...
        <div class="container">
            <div class="row">
                ...
                {{-- <div class="col-md-8 offset-md-1 mt-2">
                    @if(Auth::user()->image)
                    <p><img width="50" height="50" class="img-fluid rounded-circle mr-3" src="{{asset('storage/uploads/'.Auth::user()->image)}}"> <span class="font-weight-bold">{{ Auth::user()->name }} </span></p>
                    @else
                    <p><img width="50" height="50" class="img-fluid rounded-circle mr-3" src="https://s3.eu-central-1.amazonaws.com/bootstrapbaymisc/blog/24_days_bootstrap/fox.jpg"> <span class="font-weight-bold">{{ Auth::user()->name }} </span></p>
                    @endif
                </div> --}}
